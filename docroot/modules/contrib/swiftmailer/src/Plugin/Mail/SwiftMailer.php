...
class SwiftMailer implements MailInterface, ContainerFactoryPluginInterface {
  ...
  public function mail(array $message) {
    try {
      ...
      Conversion::swiftmailer_remove_header($m, 'Bcc');
      Conversion::swiftmailer_remove_header($m, 'Cc');
      ...
      $bcc = Conversion::swiftmailer_parse_mailboxes($message['params']['headers']['Bcc']);
      $cc = Conversion::swiftmailer_parse_mailboxes($message['params']['headers']['Cc']);
