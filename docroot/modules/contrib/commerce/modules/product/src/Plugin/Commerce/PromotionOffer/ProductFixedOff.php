...
use Drupal\commerce_promotion\Plugin\Commerce\PromotionOffer\FixedOffBase;
...
/**
 * Provides a 'Product: Fixed off' offer.
 *
 * @CommercePromotionOffer(
 *   id = "commerce_promotion_product_fixed_off",
 *   label = @Translation("Fixed amount off each product in the order"),
 * )
 */
